# overlap between each of the 1,000 sets of randomly generated DRACH+ and DRACH- hits (cytoplasm fraction) 
...
load('/home/pmaragno/random/cyto_mod_type_DRACH.Rda')
m6A <- c()
non_m6A <- c()
specific <- c()
total<- c()
...
save(hits_cyto_mod_RBP_DRACH, file='/home/pmaragno/random/hits_cyto_mod_RBP_DRACH.Rda')

load('/home/pmaragno/random/cyto_mod_type_without_DRACH.Rda')
m6A <- c()
non_m6A <- c()
specific <- c()
total<- c()
...
save(hits_cyto_mod_RBP_without_DRACH, file='/home/pmaragno/random/hits_cyto_mod_RBP_without_DRACH.Rda')
