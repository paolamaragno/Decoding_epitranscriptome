...
tx_gene <- tx_gene[, 2]
save(tx_gene, file="/path/to/R_data/tx_gene.RDa")

# EXONS
exon_coord <- exonsBy(txdb, by = 'gene')
# merge the overlapping ranges 
exon_coord_red <- lapply(exon_coord, reduce)
save(exon_coord_red, file="/path/to/R_data/exon_coord_red.RDa")
...
save(exon_gene, file="/path/to/R_data/exon_gene.RDa")
...
save(five_UTR_coord_bygene_red, file="/path/to/R_data/five_UTR_coord_bygene_red.RDa")
...
save(three_UTR_coord_bygene_red, file="/path/to/R_data/three_UTR_coord_bygene_red.RDa")
...
save(coding_exons, file="/path/to/R_data/coding_exons.RDa")
...
save(stop_codon_coord_red, file="/path/to/R_data/stop_codon_coord_red.RDa")
...
save(introns_coord_red, file="/path/to/R_data/introns_coord_red.RDa")
...
save(protein_coding_genes_5UTR_3UTR_introns_exons_stop, file="/path/to/R_data/protein_coding_genes_5UTR_3UTR_introns_exons_stop.RDa")
